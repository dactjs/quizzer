...
import { QuizConvocatoryCard, QuizConvocatorySubmissions } from "@/features";
...
export async function generateMetadata({
  ...
  if (!convocatory) return { title: "Respuestas no encontradas" };

  const date = convocatory.startAt.toLocaleDateString();
  const subject = convocatory.version.quiz.subject;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Unstable_Grid2 xs={12}>
          <Widget disableDefaultSizes>
            <QuizConvocatorySubmissions submissions={submissions} />
          </Widget>
        </Unstable_Grid2>
      </Unstable_Grid2>
    </Container>
